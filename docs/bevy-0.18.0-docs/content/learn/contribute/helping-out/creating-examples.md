...
The point is to prove to the reader that Bevy _can_ make projects like this, not to actually make a project.
...
If you _need_ an asset to demonstrate a newly added feature, make it as small as possible.
