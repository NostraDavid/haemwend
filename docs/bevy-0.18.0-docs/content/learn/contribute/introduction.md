...
- **Civil discourse**: We need to collectively discuss ideas, and the best ideas _should_ win, but conversations need to remain respectful at all times. Remember that we're all in this together, and to always follow our [Code of Conduct].
...
This uses a _ton_ of CI resources, so be kind to the planet and try to do some quick local validation first.
