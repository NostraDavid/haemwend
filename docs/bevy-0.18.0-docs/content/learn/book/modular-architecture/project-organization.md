...
- keeping your code _reasonably_ untangled
...
We _don't_ pull in a library for this, because we know that we're going to need to heavily customize the exact behavior.
